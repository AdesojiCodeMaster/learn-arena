# -*- encoding: utf-8 -*-
# stub: webdrivers 4.7.0 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :add_runtime_dependency then
    ...
    s.add_runtime_dependency(%q<selenium-webdriver>.freeze, ["> 3.141", "< 5.0"])
  else
    ...
    s.add_dependency(%q<selenium-webdriver>.freeze, ["> 3.141", "< 5.0"])
  end
end
